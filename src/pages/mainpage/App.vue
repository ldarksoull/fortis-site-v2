  ...
  <div class="fullpage-container">
    ...
    <div class="fullpage-wp" v-fullpage="opts" ref="fullpage">
      <div class="page-1 page mainpage wrapper">
          ...
          <div class="modal" v-if="openModal && modalPage === 'login'">
            ...
            <div class="modal-content">
              <form class="modal-form mb" @submit.prevent="">
                ...
                <a href="/lk" class="modal-btn">Войти</a>
              </form>
        ...
        <transition name="fade">
          <div class="loading-overlay" v-if="load" :class="{ loading: load }"></div>
        </transition>
        ...
        <nav class="buttons">
          ...
          <a
            href="https://www.youtube.com/channel/UCXbi1k6SD4CTkQv7RYesSXg"
            target="_blank"
            rel="noopener"
            class="social-btn social-btn-3 animate__animated"
            v-animate="{ value: 'animate__fadeIn', delay: 400 }"
          ></a>
      ...
      <div class="page-2 page about-us wrapper">
        <div class="about-us__side animate__animated" v-animate="{ value: 'animate__fadeInLeft' }">
          ...
          <div class="about-us__text">
            Молодой и амбициозный проект с хорошей планкой ролевой игры. <br />
            Наш проект создан для того чтобы игроки могли ощутить настоящую ролевую игру без ООС информации в голосовой чат, отыгрыша визуально видных действий и прочей лабуды.
          </div>
          <div class="circle about-us__side-circle-1 anim-delay-6"></div>
          <div class="circle about-us__side-circle-2 anim-delay-2"></div>
        </div>
        <div class="about-us__man animate__animated" v-animate="{ value: 'animate__fadeInRight', delay: 200 }"></div>
